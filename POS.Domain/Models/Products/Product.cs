...
namespace POS.Domain.Models.Products
{
    ...
    public class Product : BaseEntity
    {
        ...
        // Calculated quantity based on initial stock, purchases and sales
        public double Quantity(int? warehouseId = null)
        {
            ...
            // Include initial quantity in calculation
            return InitialQuantity + purchaseQuantity - saleQuantity;
        }
        ...
        public double InitialQuantity
        {
            ...
            set
            {
                if (_initialQuantity != value)
                {
                    _initialQuantity = value;
                    NotifyPropertyChanged(nameof(InitialQuantity));
                }
            }
        }

        // Computed Stock Status Properties
        public double CurrentQuantity => Quantity();
        public double? Cost => GetLastPurchasePrice();
        public bool IsLowStock => Quantity() > 0 && Quantity() <= (MinStock ?? 0);
